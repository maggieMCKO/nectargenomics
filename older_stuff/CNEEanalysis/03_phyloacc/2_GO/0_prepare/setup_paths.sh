...
# export chicken_anno="${cneeAna_DIR}GCF_000002315.6_GRCg6a_genomic_chrtabFixed2.gff" # (galgal.chrx)
export chicken_anno="${cneeAna_DIR}GCF_000002315.6_GRCg6a_genomic_chrtabFixed.gff" # just chr
...
export trans_matrix="${cneeAna_DIR}00_maf_gff_preprocessing/galgal6a_2315.6_acc3.tsv"  #galgal6.chrx
