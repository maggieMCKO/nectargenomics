...
#SBATCH -o log6_concatseq_%A.out
#SBATCH -e log6_concatseq_%A.err
#SBATCH -J concatseq
...
export dir_cneealigned=liftover_proc/5_aligned_cnees/
mkdir -p ${dir_cneealigned}
...
# copy to WD
cp galloseq.partitions.txt ${dir_cneealigned}
cp galloseq_gapFixed.fa ${dir_cneealigned}
cp galloseq.part.bed ${dir_cneealigned}
cp list ${dir_cneealigned}
