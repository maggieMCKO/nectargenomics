...
path = paste0(project_path, "exp_all_nectar_correctExp_v7_", Sys.Date(), ".csv")
write_csv(nectars_clades_out_tb, file = path, na = "NA")

path = paste0(project_path, "exp_all_control_correctExp_v7_", Sys.Date(), ".csv")
...
out_path = paste0(project_path, "/acc_cnee_sets_v7/")
dir.create(out_path)

tmp_sets = c("hummingbirds", "parrots", "honeyeaters", "sunbirds")
...
target_file = list.files(path, ".*_basalPlusExtension_\\w+_v72.bed", full.names = T); target_file # great default assign rule
