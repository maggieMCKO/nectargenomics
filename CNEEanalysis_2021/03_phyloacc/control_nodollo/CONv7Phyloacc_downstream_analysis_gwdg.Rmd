...
tmp_sets = c('swifts', 'falcons', 'lyrebirds', 'passerides')
...
target_file = list.files(control_path, ".*_basalPlusExtension_\\w+_v72.bed", full.names = T); target_file # great default assign rule
